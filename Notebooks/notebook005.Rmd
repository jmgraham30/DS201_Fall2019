...
Rather than consider all of the possibilities that may arise in regard to creating visualizations, we will proceed with a series of examples that can then be modifed or built upon in other ways in the future. 
...
Each geom function in ggplot2 takes a **mapping** argument. This defines how variables in your dataset are mapped to visual properties. The mapping argument is always paired with **aes** that specifies how the variables in the data get associated with the **aesthetics** of the plot. 
