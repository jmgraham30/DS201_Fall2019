...
represents a prediction $\hat{Y}$ for $Y$. 
...
The $y$-values along the curve  make up the predictions corresponding to the $y$-values in the data points. The corresponding residuals are also shown. 
